  ...
  return (
    <> 
      ...
      <p className="title">분석형</p>
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ENTPimg} className="analytic_imgback" onClick={()=>{mbticheck('ENTP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
     ...
     {/* 여기까지 */}
      ...
      <p className="title">외교형</p>
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+INFJimg} className="diplomatic_imgback" onClick={()=>{mbticheck('INFJ');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+INFPimg} className="diplomatic_imgback" onClick={()=>{mbticheck('INFP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ENFJimg} className="diplomatic_imgback" onClick={()=>{mbticheck('ENFJ');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ENFPimg} className="diplomatic_imgback" onClick={()=>{mbticheck('ENFP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ISTJimg} className="manager_imgback" onClick={()=>{mbticheck('ISTJ');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ISFJimg} className="manager_imgback" onClick={()=>{mbticheck('ISFJ');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ESTJimg} className="manager_imgback" onClick={()=>{mbticheck('ESTJ');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ESFJimg} className="manager_imgback" onClick={()=>{mbticheck('ESFJ');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
    ...
    <p className="title">탐험가형</p>
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ISTPimg} className="explorer_imgback" onClick={()=>{mbticheck('ISTP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ISFPimg} className="explorer_imgback" onClick={()=>{mbticheck('ISFP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ESTPimg} className="explorer_imgback" onClick={()=>{mbticheck('ESTP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
        ...
        <div className="abcc">
          <div className="hover13 column">
            <div>
              <figure style={{width:"70%", marginLeft:"14%" }}><img src={process.env.PUBLIC_URL+ESFPimg} className="explorer_imgback" onClick={()=>{mbticheck('ESFP');}} style={{cursor:"pointer"}}/></figure>
                <div className="textpo">
